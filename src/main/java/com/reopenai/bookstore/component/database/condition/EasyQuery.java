package com.reopenai.bookstore.component.database.condition;
...
public interface EasyQuery<CHILDREN, T> {
     ...
     * <p>Example: orderByAsc(true, "id")</p>
     *
     * @param condition Execution condition
     * @param column    column Single field
     * @return CHILDREN
     */
    ...
    /**
     * Sorting: ORDER BY field, ... ASC
     * <p>Example: orderByAsc("id")</p>
     *
     * @param column Execution condition
     * @return CHILDREN
     */
    ...
    /**
     * Sorting: ORDER BY field, ... ASC
     * <p>Example: orderByAsc(true, Arrays.asList("id", "name"))</p>
     *
     * @param condition Execution condition
    ...
    /**
     * Sorting: ORDER BY field, ... ASC
     * <p>Example: orderByAsc(Arrays.asList("id", "name"))</p>
     *
     * @param columns columns
     * @return CHILDREN
     */
     ...
     * <p>Example: orderByDesc(true, "id")</p>
     *
     * @param condition Execution condition
     * @param column    column
     * @return CHILDREN
    ...
    /**
     * Sorting: ORDER BY field, ... DESC
     * <p>Example: orderByDesc(true, Arrays.asList("id", "name"))</p>
     *
     * @param condition Execution condition
     * @param columns   columns
     * @return CHILDREN
